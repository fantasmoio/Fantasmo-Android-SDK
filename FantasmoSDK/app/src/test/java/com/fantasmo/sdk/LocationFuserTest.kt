...
class LocationFuserTest {
    ...
    fun testGeometricMedian() {
        ...
        var expected = Location(0, 0, 0, 0, coordinateExpected)
        assertTrue(degreeDistance(median, expected) < 0.001)

        locations.clear()
        val coordinate1 = Coordinate(10.0, 0.0)
        val location1 = Location(0, 0, 0, 0, coordinate1)
        locations.add(location1)
        val coordinate2 = Coordinate(-10.0, 0.0)
        val location2 = Location(0, 0, 0, 0, coordinate2)
        ...
        val location3 = Location(0, 0, 0, 0, coordinate3)
        locations.add(location3)

        coordinateExpected = Coordinate(0.0, 5.77)
        expected = Location(0, 0, 0, 0, coordinateExpected)
        ...
        val location4 = Location(0, 0, 0, 0, coordinate4)
        locations.add(location4)
        val coordinate5 = Coordinate(20.0, 10.0)
        val location5 = Location(0, 0, 0, 0, coordinate5)
        locations.add(location5)
        val coordinate6 = Coordinate(10.0, 20.0)
        val location6 = Location(0, 0, 0, 0, coordinate6)
        locations.add(location6)
        val coordinate7 = Coordinate(20.0, 20.0)
        val location7 = Location(0, 0, 0, 0, coordinate7)
        ...
        val location8 = Location(0, 0, 0, 0, coordinate8)
    ...
    fun testGeometricMedianColinear(){
        ...
        val locations1 = Location(0, 0, 0, 0, coordinate1)
        ...
        val locations2 = Location(0, 0, 0, 0, coordinate2)
    ...
    fun testLocationFusion(){
        ...
        var location = Location(0, 0, 0, 0, coordinate)
        ...
        location = Location(0, 0, 0, 0, coordinate)
        result = fuser.fusedResult(location,listOf())
    ...
    fun testInliers(){
        ...
        val location5 = Location(0, 0, 0, 0, coordinate4)
        locations.add(location5)
        inliers = classifyInliers(locations)
        assertEquals(inliers.size,3)
    }
    ...
    fun testLocationFusionOutliers(){
        ...
        val expected = Location(0, 0, 0, 0, coordinateExpected)
    ...
    fun testConfidence(){
        ...
        val location2 = Location(0, 0, 0, 0, coordinate)
        locations.add(location2)
        val locations3 = Location(0, 0, 0, 0, coordinate3)
        locations.add(locations3)
        assertEquals(method.invoke(LocationFuser(),locations), FMResultConfidence.HIGH)
        assertEquals(method2.invoke(LocationFuser(),locations), FMResultConfidence.HIGH)

        locations.clear()
        val location4 = Location(0, 0, 0, 0, coordinate)
        locations.add(location4)
        val coordinate5 = Coordinate(10.0, 10.000004)
        val locations5 = Location(0, 0, 0, 0, coordinate5)
        ...
        locations.clear()
        val location6 = Location(0, 0, 0, 0, coordinate)
        locations.add(location6)
        val coordinate7 = Coordinate(10.0, 10.000010)
        val locations7 = Location(0, 0, 0, 0, coordinate7)
        locations.add(locations7)
        assertEquals(method.invoke(LocationFuser(),locations), FMResultConfidence.LOW)
        assertEquals(method2.invoke(LocationFuser(),locations), FMResultConfidence.LOW)

        val location8 = Location(0, 0, 0, 0, coordinate)
        locations.add(location8)
        assertEquals(method2.invoke(LocationFuser(),locations), FMResultConfidence.MEDIUM)

        val location9 = Location(0, 0, 0, 0, coordinate)
        locations.add(location9)
        assertEquals(method2.invoke(LocationFuser(),locations), FMResultConfidence.MEDIUM)

        val location10 = Location(0, 0, 0, 0, coordinate)
